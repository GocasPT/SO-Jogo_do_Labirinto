...
USERMANAGER_DIR = ${SRC_DIR}/${MOTOR}/${USERMANAGER}/${USERMANAGER}

BOT_DIR = ${SRC_DIR}/${BOT}/${BOT}

OBJ_JOGOUI = ${OBJ_DIR}/${JOGOUI}.o ${OBJ_DIR}/${NAMEPIPE}_${JOGOUI}.o ${OBJ_DIR}/${UI}.o
OBJ_MOTOR = ${OBJ_DIR}/${MOTOR}.o ${OBJ_DIR}/${NAMEPIPE}_${MOTOR}.o ${OBJ_DIR}/${CONSOLA}.o ${OBJ_DIR}/${MAPMANAGER}.o ${OBJ_DIR}/${USERMANAGER}.o
...
${OBJ_DIR}/${USERMANAGER}.o: ${USERMANAGER_DIR}.c
	${CC} -c $< -o $@ ${CFLAGS}
